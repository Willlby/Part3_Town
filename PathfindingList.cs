...
// This class will represent a list (e.g. open and closed list) in our A* algorithm. The A* algorithm will use the PathfindingList to keep track of which nodes have been visited by the algorithm.
